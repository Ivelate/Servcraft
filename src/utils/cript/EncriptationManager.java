...
public class EncriptationManager 
{
	public static final String DEFAULT_KEY="6823bef096c8415f800cce35ca0cbb0a";
	    ...
	    private static byte[] hexStringToByteArray(String s) throws GeneralSecurityException {
